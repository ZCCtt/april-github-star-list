...
- [crossdesk](https://github.com/kunkundi/crossdesk)	[A lightweight, cross-platform remote desktop software with support for Web Client access | 一个轻量级跨平台远程桌面软件，支持 Web 客户端访问。]
...
- [dart_simple_live](https://github.com/SlotSun/dart_simple_live)	[简简单单的看直播]
...
- [SaveAny-Bot](https://github.com/krau/SaveAny-Bot)	[Save Telegram files to multiple storage 📂 (Alist, Disk, Webdav, S3...) . Support restrict saving content.]
...
- [Claude-4](https://github.com/china-claude/Claude-4)	[Claude 4 国内免费使用指南~ （支持 Claude Sonnet 4，无需翻墙）【2025年11月更新】]
...
- [Pixuli](https://github.com/trueLoving/Pixuli)	[🖼️ 智能图片管理应用 - 基于 AI 的图片分析、自动标签生成、批量处理]
...
- [Cloudflare-proxy](https://github.com/eooce/Cloudflare-proxy)	[Running VLESS + trojan + shadowsocks on cloudflare workers and snippets]
